                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex justify-between gap-6">
                                <div className="flex gap-3">
                                    <img src="https://ik.imagekit.io/q5tv5x3k8/Move2Fit/exercise%20(2)%201.svg?updatedAt=1741195777018" alt="" />
                                    <p>20kg</p>
                                </div>
                                <div className="flex gap-3">
                                    <img src="https://ik.imagekit.io/q5tv5x3k8/Move2Fit/repeat%201.svg?updatedAt=1741195776962" alt="" />
                                    <p>25</p>
                                </div>
                                <div className="flex gap-3">
                                    <img src="https://ik.imagekit.io/q5tv5x3k8/Move2Fit/time-left%201.svg?updatedAt=1741195777094" alt="" />
                                    <p>35min</p>
                                </div>
                            </div>
