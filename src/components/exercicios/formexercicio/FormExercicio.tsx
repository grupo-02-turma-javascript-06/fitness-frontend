        ...
        <>
            <div className="container flex flex-col mx-auto items-center my-8">
                ...
                <form className="flex flex-col w-1/2 gap-4 ">
                    ...
                    <div className="flex flex-col gap-2">
                        <label htmlFor="descricao" className="text-[#1E2729]">Descrição</label>
                        <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-2">
                        <label htmlFor="carga" className="text-[#1E2729]">Carga</label>
                        <input
                        type="text"
                    ...
                    <div className="flex justify-between gap-4">
                        <div className="flex flex-col gap-2 w-full">
                            <label htmlFor="foto" className="text-[#1E2729]">Repetição</label>
                            <input
                            type="text"
                        ...
                        <div className="flex flex-col gap-2 w-full">
                            <label htmlFor="tempo" className="text-[#1E2729]">Tempo</label>
                            <input
                            type="text"
